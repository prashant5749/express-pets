...
exports.submitContact = async function (req, res, next) {
  ...
  try {
    const promise1 = transport.sendMail({
      ...
      <p>We appreciate your interest in ${doesPetExist.name} and one of our staff members will reach out to you shortly! Below is the copy of the message you sent us for your personal records:</p>
    ...
    const promise2 = transport.sendMail({
      ...
      html: `<h3 style="color: purple; font-size: 30px; font-weight:normal;">Someone New</h3>
  ...
  res.send("Thank for sending your data");
};
